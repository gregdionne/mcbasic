...
ldge_ir2_sr2_ss			; numCalls = 2
	.module	modldge_ir2_sr2_ss
	ldab	r2
	stab	0+argv
	ldd	r2+1
	std	1+argv
...
ldge_ir2_sr2_sx			; numCalls = 1
	.module	modldge_ir2_sr2_sx
	ldab	r2
	stab	0+argv
	ldd	r2+1
	std	1+argv
...
ldge_ir3_sr3_sx			; numCalls = 2
	.module	modldge_ir3_sr3_sx
	ldab	r3
	stab	0+argv
	ldd	r3+1
	std	1+argv
