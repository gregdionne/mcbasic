...
add_fr3_fx_fd			; numCalls = 2
	.module	modadd_fr3_fx_fd
	std	tmp1
	ldab	0,x
	stab	r3
	ldd	1,x
...
shift_fr1_fr1_pb			; numCalls = 13
	.module	modshift_fr1_fr1_pb
	ldx	#r1
	jmp	shlflt

shift_fr2_fr2_pb			; numCalls = 3
