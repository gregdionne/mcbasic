...
ldeq_ir3_ix_pb			; numCalls = 1
	.module	modldeq_ir3_ix_pb
	cmpb	2,x
	bne	_done
	ldd	0,x
_done
...
ldlt_ir2_ix_ir2			; numCalls = 2
	.module	modldlt_ir2_ix_ir2
	ldd	1,x
	subd	r2+1
	ldab	0,x
	sbcb	r2
