...
dec_fr2_fx			; numCalls = 2
	.module	moddec_fr2_fx
	ldd	3,x
	std	r2+3
	ldd	1,x
	subd	#1
...
hlf_fr2_fx			; numCalls = 4
	.module	modhlf_fr2_fx
	ldab	0,x
	asrb
	stab	r2
	ldd	1,x
...
ldeq_ir2_fr2_ix			; numCalls = 2
	.module	modldeq_ir2_fr2_ix
	ldd	r2+3
	bne	_done
	ldd	r2+1
	subd	1,x
...
ldeq_ir2_ix_fd			; numCalls = 2
	.module	modldeq_ir2_ix_fd
	std	tmp1
	ldab	0,x
	stab	r2
	ldd	1,x
