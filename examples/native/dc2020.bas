...
515 PRINT"      åå       åå
516 PRINT"      ÄåååååååååÄ
517 PRINT"      ÉÄÄÄÄÄÄÄÄÄÉ
518 PRINT"      äÄÖ  Ä  äÄÖ
519 PRINT"      äÄÖ  Ä  äÄÖ
520 PRINT"       ÄÖ     äÄ
525 PRINT@0,"";
...
600 CLS7
610 PRINT@256,"";
620 PRINT"ÔÔÔÔÔÔÔÔÔÔÔÔÔ‡„‡ÏÏÏÏÏÔÔÔÔÔÔÔÔÔÔÔ";
621 PRINT"ÔÔÔÔÔÔÔÔÔÔÔÔÔ‡Ï‡ÔÔ‡Ô‡ÔÔÔÔÔÔÔÔÔÔÔ";
622 PRINT@0,"";
630 RETURN
650 CLS
655 PRINT@448,"";
...
663 PRINT"              Ä≤∞±∞Ö
664 PRINT"              ä¥º∏∞
665 PRINT"     ÉÇååååååååÄÄÄÑååååååàÉ"
666 PRINT"       ÉÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÉ"
667 PRINT"         ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ"
668 PRINT"           ÄÄÄÄÄÄÄÄÄÄÄ
669 PRINT"              ÄÄÄÄÄÄÄ
670 PRINT"               âÜ âÜ
680 FORX=1TO15
...
928 PRINT@437,"6";
929 PRINT@445,"8";
930 PRINT@160,"mapÄofÄcastles";
931 PRINT@50,"gameÄlevelÄ";L;
932 PRINT@64,"score=";SC;
933 IFSC=>PTHENPRINT@96,"**canêwin**";
934 PRINT@85,"(";P;")";
935 REM HOLDER
