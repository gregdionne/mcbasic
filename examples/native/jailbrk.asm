...
LINE_2000
	...
	; X=SHIFT(PEEK(17024) AND 1,8)+PEEK(17025)+M-1
...
and_ir3_ir3_pb			; numCalls = 1
	.module	modand_ir3_ir3_pb
	andb	r3+2
	clra
	std	r3+1
	staa	r3
...
sub_ir3_ir3_ir4			; numCalls = 1
	.module	modsub_ir3_ir3_ir4
	ldd	r3+1
	subd	r4+1
	std	r3+1
	ldab	r3
