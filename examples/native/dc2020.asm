...
LINE_620
	...
	; PRINT "ÔÔÔÔÔÔÔÔÔÔÔÔÔ‡„‡ÏÏÏÏÏÔÔÔÔÔÔÔÔÔÔÔ";
...
LINE_621
	...
	; PRINT "ÔÔÔÔÔÔÔÔÔÔÔÔÔ‡Ï‡ÔÔ‡Ô‡ÔÔÔÔÔÔÔÔÔÔÔ";
...
ldge_ir1_ir1_fx			; numCalls = 1
	.module	modldge_ir1_ir1_fx
	ldd	#0
	subd	3,x
	ldd	r1+1
	sbcb	2,x
