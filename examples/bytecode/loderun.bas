...
89 RETURN
90 DIMP(31,15),A(5),B(5),M,P,S,V,C,F,T,A,B,K(255),V(63),F(5),G(8),X(5),Y(5),D(5,5),N(5),C(5),U(31),T(5),W(2),W2(4)
91 DIMH(15),I(15),G,Q,I,O,D,E,J,L,N,U,W,X,Y,Z,LV,LC,NX,NY,G1,G2,MC,I$,A$,MN:POKE16925,0:POKE16926,1:GOSUB800:GOTO50
100 CLS:GOSUB65
...
805 K(44)=1:K(65)=2:K(87)=3:K(68)=4:K(83)=5:K(46)=6:MC=16384:G=128:I=175:L=16:N=32:W(1)=4:W(2)=2
806 K(70)=2:K(84)=3:K(72)=4:K(71)=5:K(13)=7:G1=142:G2=190
810 FORT=1TO5:C(T)=W(RND(2)):NEXT:K(176)=2
