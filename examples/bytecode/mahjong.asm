...
bytecode_dec_ir3_ix	.equ	43
bytecode_dec_ix_ix	.equ	44
...
bytecode_inc_ip_ip	.equ	50
bytecode_inc_ir1_ir1	.equ	51
bytecode_inc_ir1_ix	.equ	52
bytecode_inc_ir3_ix	.equ	53
