; Assembly for forloop-bytecode.bas
...
; Library Catalog
bytecode_and_ir1_ir1_pb	.equ	0
bytecode_clear	.equ	1
bytecode_forone_ix	.equ	2
bytecode_ld_ir1_ix	.equ	3
bytecode_ld_ix_ir1	.equ	4
bytecode_ld_ix_pw	.equ	5
bytecode_next	.equ	6
bytecode_or_ir1_ir1_ix	.equ	7
bytecode_peek_ir1_ix	.equ	8
bytecode_poke_ix_ir1	.equ	9
bytecode_progbegin	.equ	10
bytecode_progend	.equ	11
bytecode_rsub_ir1_ir1_pb	.equ	12
bytecode_to_ip_pb	.equ	13
bytecode_to_ip_pw	.equ	14
