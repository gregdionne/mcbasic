...
//   Form 3:  ON boolean - -1 GOTO/GOSUB label : statements
// replaces with:
//   Form 1: IF     boolean GOTO/GOSUB label ELSE <statements>
//   Form 2: IF NOT boolean GOTO/GOSUB label ELSE <statements>
//   Form 3: IF NOT boolean GOTO/GOSUB label ELSE <statements>
//
// TODO: implement the other gerrieatric forms:
// TODO:   Form 4:  ON boolean+2 GOSUB label1,label2
// TODO:   Form 5:  ON 1-boolean GOSUB label1,label2
// TODO: replacing with:
// TODO:   Form 4:  IF boolean THEN GOSUB label1 ELSE GOSUB label2 ENDIF
// TODO:   Form 5:  IF boolean THEN GOSUB label2 ELSE GOSUB label1 ENDIF
