...
public:
  ...
  virtual bool inspect(const Accum & /*s*/) const { return false; }
  virtual bool inspect(const Decum & /*s*/) const { return false; }
  virtual bool inspect(const Necum & /*s*/) const { return false; }
