...
public:
  ...
  std::string regInt_extInt_regInt(InstArrayRef1 &inst) override;
  std::string regInt_extFlt_regInt(InstArrayRef1 &inst) override;
  std::string regInt_extStr_regInt(InstArrayRef1 &inst) override;
  std::string regInt_extInt_dexInt(InstArrayRef1 &inst) override;
  std::string regInt_extFlt_dexInt(InstArrayRef1 &inst) override;
  std::string regInt_extStr_dexInt(InstArrayRef1 &inst) override;

  std::string regInt_extInt_regInt(InstArrayRef2 &inst) override;
  std::string regInt_extFlt_regInt(InstArrayRef2 &inst) override;
  std::string regInt_extStr_regInt(InstArrayRef2 &inst) override;
  std::string regInt_extInt_dexInt(InstArrayRef2 &inst) override;
  std::string regInt_extFlt_dexInt(InstArrayRef2 &inst) override;
  std::string regInt_extStr_dexInt(InstArrayRef2 &inst) override;

  std::string regInt_extInt_regInt(InstArrayRef3 &inst) override;
  std::string regInt_extFlt_regInt(InstArrayRef3 &inst) override;
  std::string regInt_extStr_regInt(InstArrayRef3 &inst) override;
  std::string regInt_extInt_dexInt(InstArrayRef3 &inst) override;
  std::string regInt_extFlt_dexInt(InstArrayRef3 &inst) override;
  std::string regInt_extStr_dexInt(InstArrayRef3 &inst) override;

  std::string regInt_extInt_regInt(InstArrayRef4 &inst) override;
  std::string regInt_extFlt_regInt(InstArrayRef4 &inst) override;
  std::string regInt_extStr_regInt(InstArrayRef4 &inst) override;
  std::string regInt_extInt_dexInt(InstArrayRef4 &inst) override;
  std::string regInt_extFlt_dexInt(InstArrayRef4 &inst) override;
  std::string regInt_extStr_dexInt(InstArrayRef4 &inst) override;

  std::string regInt_extInt_regInt(InstArrayRef5 &inst) override;
  std::string regInt_extFlt_regInt(InstArrayRef5 &inst) override;
  std::string regInt_extStr_regInt(InstArrayRef5 &inst) override;
  std::string regInt_extInt_dexInt(InstArrayRef5 &inst) override;
  std::string regInt_extFlt_dexInt(InstArrayRef5 &inst) override;
  std::string regInt_extStr_dexInt(InstArrayRef5 &inst) override;

  std::string regInt_extInt_regInt(InstArrayVal1 &inst) override;
  std::string regInt_extFlt_regInt(InstArrayVal1 &inst) override;
  std::string regInt_extStr_regInt(InstArrayVal1 &inst) override;
  std::string regInt_extInt_dexInt(InstArrayVal1 &inst) override;
  std::string regInt_extFlt_dexInt(InstArrayVal1 &inst) override;
  std::string regInt_extStr_dexInt(InstArrayVal1 &inst) override;

  std::string regInt_extInt_regInt(InstArrayVal2 &inst) override;
  std::string regInt_extFlt_regInt(InstArrayVal2 &inst) override;
  std::string regInt_extStr_regInt(InstArrayVal2 &inst) override;
  std::string regInt_extInt_dexInt(InstArrayVal2 &inst) override;
  std::string regInt_extFlt_dexInt(InstArrayVal2 &inst) override;
  std::string regInt_extStr_dexInt(InstArrayVal2 &inst) override;

  std::string regInt_extInt_regInt(InstArrayVal3 &inst) override;
  std::string regInt_extFlt_regInt(InstArrayVal3 &inst) override;
  std::string regInt_extStr_regInt(InstArrayVal3 &inst) override;
  std::string regInt_extInt_dexInt(InstArrayVal3 &inst) override;
  std::string regInt_extFlt_dexInt(InstArrayVal3 &inst) override;
  std::string regInt_extStr_dexInt(InstArrayVal3 &inst) override;

  std::string regInt_extInt_regInt(InstArrayVal4 &inst) override;
  std::string regInt_extFlt_regInt(InstArrayVal4 &inst) override;
  std::string regInt_extStr_regInt(InstArrayVal4 &inst) override;
  std::string regInt_extInt_dexInt(InstArrayVal4 &inst) override;
  std::string regInt_extFlt_dexInt(InstArrayVal4 &inst) override;
  std::string regInt_extStr_dexInt(InstArrayVal4 &inst) override;

  std::string regInt_extInt_regInt(InstArrayVal5 &inst) override;
  std::string regInt_extFlt_regInt(InstArrayVal5 &inst) override;
  std::string regInt_extStr_regInt(InstArrayVal5 &inst) override;
  ...
  std::string regInt_extInt_posByte(InstLdEq &inst) override;
  std::string regInt_extInt_negByte(InstLdEq &inst) override;
  std::string regInt_extInt_posWord(InstLdEq &inst) override;
  std::string regInt_extInt_negWord(InstLdEq &inst) override;
  std::string regInt_extInt_dexInt(InstLdEq &inst) override;
  std::string regInt_extInt_dexFlt(InstLdEq &inst) override;
  std::string regInt_extFlt_posByte(InstLdEq &inst) override;
  std::string regInt_extFlt_negByte(InstLdEq &inst) override;
  std::string regInt_extFlt_posWord(InstLdEq &inst) override;
  std::string regInt_extFlt_negWord(InstLdEq &inst) override;
  ...
  std::string regInt_extInt_posByte(InstLdNe &inst) override;
  std::string regInt_extInt_negByte(InstLdNe &inst) override;
  std::string regInt_extInt_posWord(InstLdNe &inst) override;
  std::string regInt_extInt_negWord(InstLdNe &inst) override;
  std::string regInt_extInt_dexInt(InstLdNe &inst) override;
  std::string regInt_extInt_dexFlt(InstLdNe &inst) override;
  std::string regInt_extFlt_posByte(InstLdNe &inst) override;
  std::string regInt_extFlt_negByte(InstLdNe &inst) override;
  std::string regInt_extFlt_posWord(InstLdNe &inst) override;
  std::string regInt_extFlt_negWord(InstLdNe &inst) override;
  ...
  std::string regInt_extInt_posByte(InstLdLt &inst) override;
  std::string regInt_extInt_negByte(InstLdLt &inst) override;
  std::string regInt_extInt_posWord(InstLdLt &inst) override;
  std::string regInt_extInt_negWord(InstLdLt &inst) override;
  std::string regInt_extInt_regInt(InstLdLt &inst) override;
  std::string regInt_extInt_regFlt(InstLdLt &inst) override;
  std::string regInt_extInt_dexInt(InstLdLt &inst) override;
  std::string regInt_extInt_dexFlt(InstLdLt &inst) override;
  std::string regInt_extFlt_posByte(InstLdLt &inst) override;
  std::string regInt_extFlt_negByte(InstLdLt &inst) override;
  std::string regInt_extFlt_posWord(InstLdLt &inst) override;
  std::string regInt_extFlt_negWord(InstLdLt &inst) override;
  std::string regInt_extFlt_regInt(InstLdLt &inst) override;
  std::string regInt_extFlt_regFlt(InstLdLt &inst) override;
  std::string regInt_extFlt_dexInt(InstLdLt &inst) override;
  std::string regInt_extFlt_dexFlt(InstLdLt &inst) override;
  std::string regInt_posByte_regInt(InstLdLt &inst) override;
  std::string regInt_negByte_regInt(InstLdLt &inst) override;
  std::string regInt_posWord_regInt(InstLdLt &inst) override;
  std::string regInt_negWord_regInt(InstLdLt &inst) override;
  std::string regInt_posByte_regFlt(InstLdLt &inst) override;
  std::string regInt_negByte_regFlt(InstLdLt &inst) override;
  std::string regInt_posWord_regFlt(InstLdLt &inst) override;
  std::string regInt_negWord_regFlt(InstLdLt &inst) override;
  std::string regInt_posByte_extInt(InstLdLt &inst) override;
  std::string regInt_negByte_extInt(InstLdLt &inst) override;
  std::string regInt_posWord_extInt(InstLdLt &inst) override;
  std::string regInt_negWord_extInt(InstLdLt &inst) override;
  std::string regInt_posByte_extFlt(InstLdLt &inst) override;
  std::string regInt_negByte_extFlt(InstLdLt &inst) override;
  std::string regInt_posWord_extFlt(InstLdLt &inst) override;
  std::string regInt_negWord_extFlt(InstLdLt &inst) override;
  ...
  std::string regInt_extStr_regStr(InstLdLt &inst) override;
  ...
  std::string regInt_extInt_posByte(InstLdGe &inst) override;
  std::string regInt_extInt_negByte(InstLdGe &inst) override;
  std::string regInt_extInt_posWord(InstLdGe &inst) override;
  std::string regInt_extInt_negWord(InstLdGe &inst) override;
  std::string regInt_extInt_regInt(InstLdGe &inst) override;
  std::string regInt_extInt_regFlt(InstLdGe &inst) override;
  std::string regInt_extInt_dexInt(InstLdGe &inst) override;
  std::string regInt_extInt_dexFlt(InstLdGe &inst) override;
  std::string regInt_extFlt_posByte(InstLdGe &inst) override;
  std::string regInt_extFlt_negByte(InstLdGe &inst) override;
  std::string regInt_extFlt_posWord(InstLdGe &inst) override;
  std::string regInt_extFlt_negWord(InstLdGe &inst) override;
  std::string regInt_extFlt_regInt(InstLdGe &inst) override;
  std::string regInt_extFlt_regFlt(InstLdGe &inst) override;
  std::string regInt_extFlt_dexInt(InstLdGe &inst) override;
  std::string regInt_extFlt_dexFlt(InstLdGe &inst) override;
  std::string regInt_posByte_regInt(InstLdGe &inst) override;
  std::string regInt_negByte_regInt(InstLdGe &inst) override;
  std::string regInt_posWord_regInt(InstLdGe &inst) override;
  std::string regInt_negWord_regInt(InstLdGe &inst) override;
  std::string regInt_posByte_regFlt(InstLdGe &inst) override;
  std::string regInt_negByte_regFlt(InstLdGe &inst) override;
  std::string regInt_posWord_regFlt(InstLdGe &inst) override;
  std::string regInt_negWord_regFlt(InstLdGe &inst) override;
  std::string regInt_posByte_extInt(InstLdGe &inst) override;
  std::string regInt_negByte_extInt(InstLdGe &inst) override;
  std::string regInt_posWord_extInt(InstLdGe &inst) override;
  std::string regInt_negWord_extInt(InstLdGe &inst) override;
  std::string regInt_posByte_extFlt(InstLdGe &inst) override;
  std::string regInt_negByte_extFlt(InstLdGe &inst) override;
  std::string regInt_posWord_extFlt(InstLdGe &inst) override;
  std::string regInt_negWord_extFlt(InstLdGe &inst) override;
  ...
  std::string regInt_extStr_regStr(InstLdGe &inst) override;
