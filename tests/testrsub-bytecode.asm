; Assembly for testrsub-bytecode.bas
...
bytecode_ld_ix_ir1	.equ	1
bytecode_pr_sr1	.equ	2
bytecode_pr_ss	.equ	3
bytecode_progbegin	.equ	4
bytecode_progend	.equ	5
bytecode_rsub_ix_ix_pb	.equ	6
bytecode_str_sr1_ix	.equ	7
bytecode_sub_ir1_ix_pb	.equ	8
bytecode_sub_ir1_pb_ix	.equ	9
