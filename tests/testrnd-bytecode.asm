; Assembly for testrnd-bytecode.bas
...
LINE_20
	...
	; PRINT STR$(RND(-1));" ";STR$(RND(0));" ";STR$(RND(-1));" ";STR$(RND(0));" \r";

	.byte	bytecode_rnd_fr1_nb
	.byte	-1
...
bytecode_irnd_ir1_pb	.equ	3
bytecode_next	.equ	4
bytecode_pr_sr1	.equ	5
bytecode_pr_ss	.equ	6
bytecode_progbegin	.equ	7
bytecode_progend	.equ	8
bytecode_rnd_fr1_nb	.equ	9
bytecode_rnd_fr1_pb	.equ	10
bytecode_str_sr1_fr1	.equ	11
bytecode_str_sr1_ir1	.equ	12
...
rnd_fr1_nb			; numCalls = 2
	.module	modrnd_fr1_nb
	jsr	getbyte
	ldaa	#-1
	staa	tmp1+1
	std	tmp2
