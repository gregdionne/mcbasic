; Assembly for testdim2-bytecode.bas
...
bytecode_arrref2_ir1_ix_ir2	.equ	1
bytecode_arrval2_ir1_ix_ir2	.equ	2
...
arrref2_ir1_ix_ir2			; numCalls = 21
...
arrval2_ir1_ix_ir2			; numCalls = 20
