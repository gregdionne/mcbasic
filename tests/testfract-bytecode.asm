; Assembly for testfract-bytecode.bas
...
bytecode_fract_fr1_fr1	.equ	2
bytecode_fract_ir1_ix	.equ	3
bytecode_ld_fx_fr1	.equ	4
bytecode_ld_fx_ir1	.equ	5
...
fract_ir1_ix			; numCalls = 1
	.module	modfract_ir1_ix
	jsr	extend
	ldd	#0
	stab	r1
	std	r1+1
