; Assembly for testme-bytecode.bas
...
LINE_20
	...
	; PRINT STR$(X(4));" ";STR$(Y);" ";STR$(Y(8,12));" \r";
...
bytecode_INTARR_X	.equ	1
bytecode_INTARR_Y	.equ	2
