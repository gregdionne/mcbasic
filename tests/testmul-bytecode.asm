...
LINE_80
	...
	; X=((1-T)*(1-T)*S(P))+SHIFT(X(P)*(1-T)*T,1)+(E(P)*T*T)
...
LINE_90
	...
	; Y=((1-T)*(1-T)*T(P))+SHIFT(Y(P)*(1-T)*T,1)+(F(P)*T*T)
...
bytecode_arrval1_ir2_ix	.equ	6
bytecode_clear	.equ	7
bytecode_cls	.equ	8
bytecode_for_fx_pb	.equ	9
bytecode_inkey_sr1	.equ	10
bytecode_irnd_ir1_pb	.equ	11
bytecode_jmpne_ir1_ix	.equ	12
bytecode_ld_fr1_fx	.equ	13
bytecode_ld_fx_fr1	.equ	14
bytecode_ld_ip_ir1	.equ	15
bytecode_ld_ip_pb	.equ	16
bytecode_ld_ir1_ix	.equ	17
bytecode_ld_ir1_pb	.equ	18
bytecode_ld_ir1_pw	.equ	19
bytecode_ld_ir2_ix	.equ	20
bytecode_ld_ir2_pb	.equ	21
bytecode_ld_ir3_pb	.equ	22
bytecode_ld_ix_pb	.equ	23
bytecode_ldeq_ir1_sr1_ss	.equ	24
bytecode_mul_fr1_fr1_fr2	.equ	25
bytecode_mul_fr1_fr1_fx	.equ	26
bytecode_mul_fr1_fr1_ir2	.equ	27
bytecode_mul_fr1_ir1_fx	.equ	28
bytecode_mul_fr2_fr2_fx	.equ	29
bytecode_mul_fr2_ir2_fr3	.equ	30
bytecode_mul_fr2_ir2_fx	.equ	31
bytecode_next	.equ	32
bytecode_pr_sr1	.equ	33
bytecode_pr_ss	.equ	34
bytecode_progbegin	.equ	35
bytecode_progend	.equ	36
bytecode_shift_fr1_fr1_pb	.equ	37
bytecode_shift_fr2_fr2_pb	.equ	38
bytecode_step_fp_fr1	.equ	39
bytecode_str_sr1_fx	.equ	40
bytecode_sub_fr1_ir1_fx	.equ	41
bytecode_sub_fr2_ir2_fx	.equ	42
bytecode_sub_fr3_ir3_fx	.equ	43
bytecode_sub_ir1_ir1_ir2	.equ	44
bytecode_to_fp_pb	.equ	45
