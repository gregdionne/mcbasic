; Assembly for testStrEqx-bytecode.bas
...
bytecode_STRVAR_X	.equ	STRVAR_X-symstart
bytecode_STRVAR_Y	.equ	STRVAR_Y-symstart
bytecode_STRVAR_Z	.equ	STRVAR_Z-symstart
