; Assembly for testmulpow2-bytecode.bas
...
LINE_30
	...
	.byte	bytecode_shift_fr1_ir1_ir2
...
bytecode_shift_fr1_ir1_ir2	.equ	9
bytecode_str_sr1_fx	.equ	10
bytecode_sub_ir2_ir2_ix	.equ	11
...
shift_fr1_ir1_ir2			; numCalls = 1
	.module	modshift_fr1_ir1_ir2
	jsr	noargs
	ldab	r2+2
	ldx	#r1
	jmp	shifti
